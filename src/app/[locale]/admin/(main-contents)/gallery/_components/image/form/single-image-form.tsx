...
type Props = {
  form: UseFormReturn<z.infer<typeof imageUrlSchema>>;
...
export const SingleImageForm: FC<Props> = ({
  form,
  folderTree,
  action,
  imageId,
    ...
    <Form {...form}>
      ...
      >
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel>{t("gallery.imageUrl.form.url")}</FormLabel>
              <FormControl>
                <div className="relative">
                  <Textarea
                    {...field}
                    rows={4}
                    placeholder={t("gallery.imageUrl.form.urlPlaceholder")}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel>{t("gallery.imageUrl.form.name")}</FormLabel>
              <FormControl>
                <Input
                  placeholder={t("gallery.imageUrl.form.namePlaceholder")}
                  {...field}
                />
              </FormControl>
              <FormDescription hidden>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel>{t("gallery.imageUrl.form.folderPath")}</FormLabel>
              <Select onValueChange={field.onChange} defaultValue={field.value}>
                <FormControl>
                  <SelectTrigger>
                    <SelectValue
                      placeholder={t(
                        "gallery.imageUrl.form.folderPathPlaceholder"
                      )}
                    />
                  </SelectTrigger>
                </FormControl>
