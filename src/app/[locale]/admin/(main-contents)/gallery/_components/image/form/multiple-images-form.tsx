...
type Props = {
  form: UseFormReturn<z.infer<typeof multipleImageUrlSchema>>;
  selectedUrls: string[];
      ...
      <form action={action} className="flex flex-col gap-4 h-full">
        <FormItem>
          ...
          <FlexColumn
            ...
            px={3}
            py={2}
            className="relative h-48 overflow-scroll"
          >
            {!selectedUrls.length && (
            ...
            {selectedUrls.map((url) => (
              ...
              >
                ...
                <span className="inline-flex justify-end truncate">{url}</span>
              </Badge>
            ))}
          </FlexColumn>
        </FormItem>
