...
>(({ className, children, height = 2, size = 5, ...props }, ref) => (
  ...
  >
    ...
    <SliderPrimitive.Thumb className={cn("relative group block rounded-full border-2 border-primary bg-background ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50", `h-${size} w-${size}`)}>
      {children &&
